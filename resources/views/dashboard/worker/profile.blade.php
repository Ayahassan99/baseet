      ...
      <div class="collapse navbar-collapse" id="navbarScroll">
        ...
        <!-- <td>Radwa samir</td>
          <td>radwa32000@gmail.com</td>-->
           <td>
       <a class="nav-link" href="http://127.0.0.1:8000/worker/logout" onclick="event.preventDefault();document.getElementById('logout-form').submit();">تسجيل الخروج</a>
               <form action="http://127.0.0.1:8000/worker/logout" method="post" class="d-none" id="logout-form"><input type="hidden" name="_token" value="kKfe8GMGWu8XInzI7pSFnS0Ko8jXaHJjLZgZoiYy"></form>
                                 </td>
                             </tr>
...
<div class="card-body " >
<button type="button" class="btn btn-primary color" data-bs-toggle="modal" data-bs-target="#staticBackdrop"> اطلب الان  </button>
