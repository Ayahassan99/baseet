...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            ...
            >
                <li class="nav-item">
                <a class="nav-link" aria-current="page" href="http://127.0.0.1:8000/worker/profile">
                   الملف الشخصى</a
                >
                </li>
                <li class="nav-item">
    ...
    <div class="arrange">
        <div class="card text-center">
            <div class="d-flex">
                ...
                <div class="mb-3"> 
                    <a href="http://127.0.0.1:8000/worker/porder" class="btn btn-primary color">تفاصيل العمل</a>
                </div>
        ...
        <div class="card text-center">
            <div class="d-flex">
                ...
                <div class="mb-3"> 
                    <a href="http://127.0.0.1:8000/worker/forder" class="btn btn-primary color">تفاصيل العمل</a>
                </div>
                <div class="card-footer text-muted">
                    مدة الطلب 
                </div>
        ...
        <div class="card text-center">
            <div class="d-flex">
                ...
                <div class="mb-3"> 
                    <a href="http://127.0.0.1:8000/worker/rorder" class="btn btn-primary color">تفاصيل العمل</a>
                </div>
                <div class="card-footer text-muted">
                    مدة الطلب 
                </div>
